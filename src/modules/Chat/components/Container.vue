...
<template>
  <div
    class="cura:h-svh cura:md:max-h-[70vh] cura:md:h-[643px] cura:flex cura:flex-col cura:w-svw cura:md:w-[400px] cura:bg-white cura:border cura:border-[#EDEFF2] cura:overflow-hidden cura:md:rounded-[20px] cura:relative"
